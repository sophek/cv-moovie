...
class Moovie {
            ...
            for (var i = 0; i < customEvents.length; i++) {
                ...
                if(customEvents[i].hasOwnProperty("fired") && customEvents[i].fired){
                    ...
                    if(video.currentTime > customEvents[i].starttime && video.currentTime < customEvents[i].endtime)
                    {
                        ...
                        moovie_el_video.insertAdjacentHTML("beforeend", "<div style='opacity:0' id='moovie_ce_"+eventID+"' class='moovie_cevent "+customEvents[i].position+" "+customEvents[i].class+"'>"+customEvents[i].content+"</div>");
    ...
    */
    ...
    toggleBlur(isBlur){
        //el.style = isBlur ? el.style.cssText + ';filter:blur(5em);' : el.style.cssText.replace(';filter:blur(5em);','');
